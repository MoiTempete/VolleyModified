 ...
 */
public class YoukuHttpRetryPolicy implements RetryPolicy {
    
	private static final String TAG = "YoukuHttpRetryPolicy";
     ...
     */
    public YoukuHttpRetryPolicy() {
        this(DEFAULT_TIMEOUT_MS, DEFAULT_TIMEOUT_MS, DEFAULT_MAX_RETRIES, DEFAULT_BACKOFF_MULT);
    }
    
    public YoukuHttpRetryPolicy(int connectTimeout, int readTimeout, int maxNumRetries, float backoffMultiplier) {
