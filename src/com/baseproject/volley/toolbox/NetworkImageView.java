...
public class NetworkImageView extends ImageView {
    ...
    /** Control whether to display a ImageView with a fade effect */
    ...
    /**
     * Whether to display the fade effect,if set this will override
     * Profile.setImageViewFadeIn();
     * 
     * Call this before setImageUrl
     * 
     * @param fadIn
     *            true display imageView with fade effect;
     *            false otherwise
     */
    public void setFadIn(boolean fadIn) {
        mIsFadIN = fadIn;
    }

    /**
     * @return Whether display imageView with fade effect;
     */
        ...
        ImageContainer newContainer = mImageLoader.get(mUrl, new ImageListener() {
            ...
            public void onResponse(final ImageContainer response, boolean isImmediate) {
                ...
                if (response.getBitmap() != null) {
                    ImageLoader.setImageBitmap(response.isFadIn(), NetworkImageView.this, response.getBitmap());
                } else if (mDefaultImageId != 0) {
                    setImageResource(mDefaultImageId);
                }
            }
        }, maxWidth, maxHeight, mIsFadIN, null);
