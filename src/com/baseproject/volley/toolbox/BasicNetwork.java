...
public class BasicNetwork implements Network {
    ...
    private static int DEFAULT_POOL_SIZE = 4096 * 20;
        ...
        while (true) {
            ...
            try {
                ...
                if (statusCode == HttpStatus.SC_NOT_MODIFIED) {
                    return new NetworkResponse(HttpStatus.SC_NOT_MODIFIED, request.getCacheEntry() == null ? null
                            : request.getCacheEntry().data, responseHeaders.get("Etag"),
                            HttpHeaderParser.parseCharset(responseHeaders), true, request.getExpireTime());
                }
                ...
                attemptRetryOnException("socket", request,
                        new VolleyError(Util.buildHttpErrorMsg("failed", -1, HttpRequestManager.STATE_ERROR_TIMEOUT)));
    ...
    private static void attemptRetryOnException(String logPrefix, Request<?> request, VolleyError exception)
        ...
        int oldTimeout = request.getReadTimeoutMs();
